...
<head>
    <base href="${ctx}/">
    <title>修改图书信息</title>
    <link rel="stylesheet" href="assets/book/css/editbook.css">
    ...
    <script>
        ...
        const borrowing="${book.borrowing}";
        //只能写在这里，只有jsp才会被tomcat服务器解析，js（静态资源文件）不会
    </script>
    <script src="assets/book/js/editbook.js"></script>
</head>
<body>
<h1>请输入修改信息</h1>
