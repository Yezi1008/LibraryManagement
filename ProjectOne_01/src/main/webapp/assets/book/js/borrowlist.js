$(function (){
    ...
    //         location.href=ctx+"/borrow/edit?id="+id;
    //     }
    // });
    //查询
...
function search(pageNo=1,pageSize=10){
    ...
    $.post(url,data,function (resp){
        ...
        for (let i=0;i<rows.length;i++){
            ...
            $tr.append($("<td>"+borrow.id+"</td>"));
            $tr.append($("<td>"+borrow.name+"</td>"));
            $tr.append($("<td>"+borrow.sex+"</td>"));
            $tr.append($("<td>"+(borrow.age || "")+"</td>"));
            $tr.append($("<td>"+borrow.bookname+"</td>"));
            $tr.append($("<td>"+(borrow.borrowtime || "")+"</td>"));
            $tr.append($("<td>"+(borrow.phone || "")+"</td>"));
